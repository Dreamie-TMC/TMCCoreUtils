...
/// </summary>
public class GuiHelper(IApiContainerWrapper apiContainerWrapper)
{
    internal ApiContainerWrapper ApiContainerWrapper { get; set; } =
        (ApiContainerWrapper)apiContainerWrapper;
    ...
    public void SetPadding(int all) => ApiContainerWrapper.CurrentContainer.Gui.SetPadding(all);
    ...
    public void ClearText() => ApiContainerWrapper.CurrentContainer.Gui.ClearText();
    ...
    public void DrawEllipse(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawEllipse(
            x,
            y,
            width,
            height,
    ...
    public void DrawImage(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawImage(
            img,
            x,
            y,
            width,
    ...
    public void ClearImageCache() => ApiContainerWrapper.CurrentContainer.Gui.ClearImageCache();
    ...
    public void DrawImageRegion(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawImageRegion(
            img,
            sourceX,
            sourceY,
            sourceWidth,
    ...
    public void DrawPie(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawPie(
            x,
            y,
            width,
            height,
    ...
    public void DrawRectangle(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawRectangle(
            x,
            y,
            width,
            height,
    ...
    public void DrawString(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawString(
            x,
            y,
            message,
            forecolor,
    ...
    public void DrawText(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.DrawText(
            x,
            y,
            message,
            forecolor,
    ...
    public void PixelText(
        ...
        ApiContainerWrapper.CurrentContainer.Gui.PixelText(
            x,
            y,
            message,
            forecolor,
